...
while True:
    ...
    if(len(goodMatch2)>MIN_MATCH_COUNT):
        ...
        cv2.putText(queryImageBGR, "(%.2f, %.2f, %.2f)" % (cx2, cy2, cz2), (queryImageBGR.shape[1] - 700, queryImageBGR.shape[0] - 150), cv2.FONT_HERSHEY_SIMPLEX,1, (255, 0, 0), 3)
        cv2.putText(queryImageBGR, "%.1fft" % (dist / 12),(queryImageBGR.shape[1] - 700, queryImageBGR.shape[0] - 50), cv2.FONT_HERSHEY_SIMPLEX,2.0, (255, 0, 0), 3)
